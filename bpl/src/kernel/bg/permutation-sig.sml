...
sig
  ...
  (** Compute the division of a permutation by a list of local outer names lists.
   ...
   * @params Xss pi
   * @param Xss      List of local outer names lists.
   * @param pi       The permutation.
   * @exception      NotProduct if pi is not a product of some Xss and pi'.
   *) 
  val divide : 'kinda permutation -> nameset list list -> 'kindb permutation
