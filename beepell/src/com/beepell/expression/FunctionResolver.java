...
import com.beepell.exceptions.XsltStylesheetNotFound;
...
public class FunctionResolver extends Resolver implements XPathFunctionResolver {
     ...
     */
    private boolean convertPropertyValues;

    /**
     * Create a FunctionResolver based on an ExpressionContext.
     * 
     * @param expressionContext Expression context used to resolve variables and
     *            properties.
     * @param namespaceContext Namespace context used to qualify property names.
     */
    public FunctionResolver(ExpressionContext expressionContext, NamespaceContext namespaceContext) {
        super(expressionContext);
        this.namespaceContext = namespaceContext;
        this.convertPropertyValues = Boolean.parseBoolean(Settings.getInstance().getSetting("expressions.functions.getvariableproperty.converttoxpathobjects", "true"));
    }
                ...
                return new XPathFunction() {
                    ...
                    public Object evaluate(List args) throws XPathFunctionException {
                        try {
                            ...
                            Node value = context.getVariablePropertyValue(variable, property);
                            if (convertPropertyValues)
                                return toXPathObject(value, context.getVariablePropertyType(property));
                            else
                                return value;
    ...
    private QName toQName(String string) {
     ...
     * @throws XsltInvalidSource if the source is not an element node
     *             (or a node-set with a single element node)
     */
    private Node doXslTransform(URI style, Element sourceElement, Object[] properties) throws TransformerException, XsltInvalidSource, XsltStylesheetNotFound {
