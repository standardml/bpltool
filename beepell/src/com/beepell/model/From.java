...
@XmlType(name = "tFrom", propOrder = { "any" })
public class From {
    ...
    @XmlAttribute
    protected RolesEnumeration endpointReference;
    ...
    public Element getLiteral() {
        ...
        if (any != null && any.getLocalName().equals("literal"))
            return any;
        else
            return null;
    }
     ...
     * 
     * @param value allowed object is {@link Literal }
     */
    public void setLiteral(Element value) {
        this.any = value;
    }
     ...
     * 
     * @return possible object is {@link RolesEnumeration }
     */
    public RolesEnumeration getEndpointReference() {
     ...
     * 
     * @param value allowed object is {@link RolesEnumeration }
     */
    public void setEndpointReference(RolesEnumeration value) {
