...
public class PickTest extends TestCase {
    ...
    public void testPick() {
        ...
        try {
            File bpel = new File("test/com/beepell/activity/structured/pick.bpel");
    ...
    private static String invoke(String number) throws SOAPException, IOException {
        ...
        String soapAction = "http://beepell.com/samples/proxy/definitions/echo" + number;
        ...
        SOAPElement content = body.addBodyElement(envelope.createName("echoOperation" + number, "rpc", "http://beepell.com/samples/proxy/definitions"));
