...
public class IfTest extends TestCase {
    ...
    public void testIf() {
        ...
        try {
            File bpel = new File("test/com/beepell/activity/structured/if.bpel");
            ...
            result = invoke("first elseif");
            Thread.sleep(100); // Let process thread finish
            assertEquals("FIRST ELSEIF", result);

            result = invoke("second elseif");
            Thread.sleep(100); // Let process thread finish
            assertEquals("SECOND ELSEIF", result);

            result = invoke("third elseif");
            Thread.sleep(100); // Let process thread finish
            assertEquals("THIRD ELSEIF", result);
