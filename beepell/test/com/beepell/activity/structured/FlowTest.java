...
public class FlowTest extends TestCase {
    ...
    public void testFlow() {
        ...
        try {
            ...
            File bpel = new File("test/com/beepell/activity/structured/flow.bpel");
            ...
            assertTrue( 4000 < time && time < 8000 );
    ...
    private static String invoke() throws SOAPException, IOException {
        ...
        String endpointAddress = "http://localhost:9095/samples/proxy/definitions/echo";
