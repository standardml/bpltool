...
namespace ITU.DK.DCRS.CommonTypes.Examples
{
    public class DCRSExamples
    {
        ...
        public static DCRSModel BuchiToDCRTranslationsExample2()
        {
        ...
        public static DCRSModel BuchiToDCRTranslationsExample3()
        {
            ...
            var conditions = new short[,] {
                                     {0, 0}, {1, 1}, // Self conditions to blocking events.
                                     {2, 0}, //{4, 0}, // conditions to main events sets such as x condition to : a, c
                                     {3, 1},{4, 1},  // conditions to main events sets such as y condition to : b, c
