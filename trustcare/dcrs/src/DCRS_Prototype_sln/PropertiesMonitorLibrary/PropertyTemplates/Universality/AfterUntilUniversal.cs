...
{
    public class AfterUntilUniversal : PropertyMonitorBase
    {
               
        // Note: AfterUntil (Universal) is same as BetweenUniversal
        // between and will have many instances of scope instead of just one instance
        // like in case of before and after.

        // AfterUntil (universal (P), Q, R)
        ...
        public AfterUntilUniversal(short actionP, short actionQ, short actionR)
        {
