 ...
 * <p>
 * [6.1] &quot;A &lt;partnerLinkType&gt; characterizes the conversational
 * relationship between two services by defining the roles played by each of the
 * services in the conversation and specifying the portType provided by each
 * service to receive messages within the context of the conversation. Each
 * &lt;role&gt; specifies exactly one WSDL portType. &quot;
 * </p>
 * 
 * @author Tim Hallwyl, 2006 - 2008
 */
public class PartnerLinkType {
    ...
    public Role getRole(final String name) {
        for (int i = 0; i < this.roles.length; i++) {
            if (this.roles[i] != null && this.roles[i].getName().equals(name))
                return this.roles[i];
        }
        return null;
    }
    ...
    /**
     * Gets the PortType by Role Name. Equvilant to
     * getRole(roleName).getPortType()
     * 
     * @param roleName
